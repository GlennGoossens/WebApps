...
var should = require('should'),
	...
	app = require('../../server'),
	productApi = require('./models.server.routes.tests.api.js')(app, 'Product','/products/'),
	categoryApi = require('./models.server.routes.tests.api.js')(app, 'Category', '/categories/'),
